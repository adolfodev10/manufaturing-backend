...
exports.gerarMensagemUsuarioCriado = exports.gerarMensagemEstoqueBaixo = exports.gerarMensagemVendaRealizada = exports.gerarMensagemDividaPendente = exports.gerarMensagemProdutoVencido = exports.gerarMensagemBoasVindas = exports.enviarSMSBoasVindas = void 0;
// backend/modules/services/sms/sms.service.ts
const axios_1 = __importDefault(require("axios"));
const enviarSMSBoasVindas = async (data) => {
    ...
    const mensagem = (0, exports.gerarMensagemBoasVindas)({
        name,
...
exports.enviarSMSBoasVindas = enviarSMSBoasVindas;
// ============================================
// MENSAGENS PARA O EKO
// ============================================
const gerarMensagemBoasVindas = (data) => {
...
exports.gerarMensagemBoasVindas = gerarMensagemBoasVindas;
const gerarMensagemProdutoVencido = (produto) => {
...
exports.gerarMensagemProdutoVencido = gerarMensagemProdutoVencido;
const gerarMensagemDividaPendente = (cliente, divida) => {
...
exports.gerarMensagemDividaPendente = gerarMensagemDividaPendente;
const gerarMensagemVendaRealizada = (venda) => {
    const valorFormatado = new Intl.NumberFormat('pt-AO', {
        style: 'currency',
        currency: 'AOA'
...
exports.gerarMensagemVendaRealizada = gerarMensagemVendaRealizada;
const gerarMensagemEstoqueBaixo = (produto) => {
...
exports.gerarMensagemEstoqueBaixo = gerarMensagemEstoqueBaixo;
const gerarMensagemUsuarioCriado = (data) => {
    const loginUrl = process.env.FRONTEND_URL || 'https://eko-manufaturing.vercel.app';
    return `🔐 EKO - Usuário criado: ${data.name}. Email: ${data.email} | Senha: ${data.password}. Acesse: ${loginUrl}/auth/login - EKO Sistema`;
};
exports.gerarMensagemUsuarioCriado = gerarMensagemUsuarioCriado;
